...
class ProductsController extends Controller
{
    ...
    {
        $listsCategory = $this->categoryRepository->listas();
        return view("admin.products.create", compact('listsCategory'));
    }
    ...
    public function edit($id)
    {
        ...
        $listsCategory = $this->categoryRepository->lists('name','id');
        return view('admin.products.edit', compact('products', 'listsCategory'));
    }
